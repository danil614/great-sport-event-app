...
{
    public partial class ListAthletesForm : DockContent
    {
        public DataGridViewRow SelectedItem { get; set; }

        public ListAthletesForm(bool isSelectionMode)
        {
            InitializeComponent();
            UpdateDataGridView();
            SetVisibleItems();
        ...
        {
            // Получаем запрос
            DataTable dataTable = Query.GetListAthletes(out bool isConnected);
        ...
        {
            AthleteForm athleteForm = new(false, -1, -1);
            var dialogResult = athleteForm.ShowDialog();
        ...
        private void EditToolStripButton_Click(object sender, EventArgs e)
        {
            ...
            AthleteForm athleteForm = new(true, currentRowId, -1);
            var dialogResult = athleteForm.ShowDialog();
        ...
        private void DeleteToolStripButton_Click(object sender, EventArgs e)
        {
            ...
            {
                int currentRowId = (int)DataGridView.CurrentRow.Cells[0].Value;
                var athlete = context.Athletes.Find(currentRowId);
